...
export default function ResourcesPage() {
  ...
  async function handleStatusChange(requestId: string, newStatus: string) {
    try {
      ...
      setSuccessMessage(`Richiesta ${newStatus === 'approved' ? 'approvata' : 'rifiutata'} con successo!`)
  ...
  async function handleDeleteRequest(requestId: string) {
    ...
    try {
      ...
      setSuccessMessage('Richiesta eliminata con successo!')
      setShowSuccessAlert(true)
      setTimeout(() => setShowSuccessAlert(false), 3000)
      fetchRequests()
    } catch (error: any) {
  ...
  function exportToCSV() {
    try {
      ...
      setSuccessMessage('File CSV esportato con successo!')
      setShowSuccessAlert(true)
      setTimeout(() => setShowSuccessAlert(false), 3000)
    } catch (error) {
      console.error('Errore durante l\'esportazione:', error)
      setSuccessMessage('Errore durante l\'esportazione del file')
      setShowSuccessAlert(true)
      setTimeout(() => setShowSuccessAlert(false), 3000)
    }
  }
