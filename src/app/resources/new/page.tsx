...
export default function NewResourceRequestPage() {
  ...
  const { notifyNewRequest } = useNotificationActions()
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      // Notifica i manager/admin della nuova richiesta
      ...
      // Reindirizza alla lista richieste
      ...
      showToast({
        type: 'error',
        title: 'Errore',
        message: 'Impossibile creare la richiesta'
      })
    } finally {
      setLoading(false)
    }
