...
export default function UsersPage() {
  ...
  async function handleAddUser(e: React.FormEvent) {
    ...
    try {
      ...
      setAlertMessage('Utente creato con successo!')
  ...
  async function handleEditUser(e: React.FormEvent) {
    ...
    try {
      ...
      setAlertMessage('Utente aggiornato con successo!')
      setAlertType('success')
      setShowAlert(true)
      setTimeout(() => setShowAlert(false), 3000)
      ...
      setAlertMessage(error.message || 'Errore durante l\'aggiornamento dell\'utente')
      setAlertType('error')
      setShowAlert(true)
    }
  }
  ...
  async function handleDeleteUser(userId: string) {
    ...
    try {
      ...
      setAlertMessage('Utente eliminato con successo')
      setAlertType('success')
      setShowAlert(true)
      setTimeout(() => setShowAlert(false), 3000)
      ...
      setAlertMessage('Errore durante l\'eliminazione dell\'utente')
      setAlertType('error')
      setShowAlert(true)
    }
  }
